...
<body> 
     ...
     <nav class="navbar navbar-expand-lg" >
        <div class="container-fluid a">
            <a class="navbar-brand" href="index.php">Tech-Buzz</a>
...
if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true) {
    echo '
                    <p class="mx-4 my-auto" style="font-weight:500;">Welcome ' . $_SESSION['useremail'] . '
    ...
    echo '<div class="btn btn-outline-danger mx-2 my-1" data-bs-toggle="modal" data-bs-target="#loginModal">Login</div>
